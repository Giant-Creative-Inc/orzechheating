		...
		array(
			...
			'params'      => array(
				...
				array(
					...
					'value'      => 'https://www.financeit.ca/en/direct/payment-plan/YT0yNzc0NzUmbD0mcD1lOTJfTjBCLWsxMjdVbWhHZE16c25BJnM9MCZ2PTE=/application-form?pf=w&slug=Z0kYPw',
				),
				array(
					'type'       => 'textfield',
...
function orzech_render_finance_calculator( $atts ) {
	$atts = shortcode_atts(
		array(
			...
			'apply_url'       => 'https://www.financeit.ca/en/direct/payment-plan/YT0yNzc0NzUmbD0mcD1lOTJfTjBCLWsxMjdVbWhHZE16c25BJnM9MCZ2PTE=/application-form?pf=w&slug=Z0kYPw',
			'el_class'        => '',
		),
		$atts,
